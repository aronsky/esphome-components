...
class BleAdvLight : public light::LightOutput, public BleAdvEntity, public EntityBase
{
 public:
  ...
  void set_min_brightness(int min_brightness);
  ...
  void set_number_min_brightness(BleAdvNumber* number) { number_min_brightness_ = number; }
 ...
 protected:
  ...
  BleAdvNumber* number_min_brightness_{nullptr};
  bool split_dim_cct_;
