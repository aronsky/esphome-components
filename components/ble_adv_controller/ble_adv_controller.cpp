...
void BleAdvController::set_min_tx_duration(int tx_duration) {
...
#endif
  if (select_encoding_ != nullptr) {
    select_encoding_->init();
  }
  if (number_duration_ != nullptr) {
    number_duration_->init();
  }
}
